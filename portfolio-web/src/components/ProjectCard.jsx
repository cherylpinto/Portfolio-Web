    ...
    <div className="flex flex-col h-full">
      ...
      >
        ...
        >
            ...
            <Link to={previewUrl} onClick={handlePreviewClick} className="h-14 w-14 border-2 border-[#ADB7BE] rounded-full relative hover:border-white group/link">
                <EyeIcon className="h-10 w-10 text-[#ADB7BE] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer group-hover/link:text-white"/>
            </Link> 
        </div>
      </div>

      <div className="text-white mt-2 rounded-b-xl bg-[#181818] py-6 px-4 flex-grow">
